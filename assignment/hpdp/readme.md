...
| 11. | ZProMax  |  <a href="./ZProMax/readme.md" ><img src="../../images/answer.png" width="24px" height="24px" ></a> | [Flow of patients to/out of Covid-19 Quarantine and Treatment Centres (PKRC), with capacity and utilisation](https://github.com/MoH-Malaysia/covid19-public/blob/main/epidemic/pkrc.csv) | Pandas-Profiling | SweetViz | DataPrep | 
