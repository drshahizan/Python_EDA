...
<p align="center">
  <img src="./images/EDA.png"  height="400" />
</p>
...
| [D-Tale](https://github.com/drshahizan/Python_EDA/blob/main/assignment/ass2/hpdp/BERUK/case_study2c/cs2c_.ipynb) | - Runs common Pandas operation with no-code.<br>- Exports code of analysis.<br>- Covers info about missing values, data statistics, correlation etc.<br>- Highlights duplicates, outliers, etc.<br>- Integrates with Jupyter Notebook. |[🌐](https://pypi.org/project/dtale/) | [:octocat:](https://github.com/man-group/dtale) |
